...
export const GAMES = [
  ...
  { id: "cascade", name: "Cascade", chill: 0, harr: 2, kind: "facilitator", noLoser: true, harrOnly: true,
    rule: "Avant de commencer, chaque joueur remplit son verre (prévois assez de boisson pour tenir la cascade). Tout le monde boit en même temps. Un joueur ne peut reposer son verre que lorsque le joueur précédent a reposé le sien. Si un joueur repose son verre avant que le précédent n'ait reposé le sien, ce joueur précédent doit finir son verre cul sec." },
