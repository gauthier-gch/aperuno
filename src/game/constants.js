...
export const GAMES = [
  ...
  { id: "cascade", name: "Cascade", chill: 0, harr: 2, kind: "facilitator",
    rule: "Tout le monde boit en même temps. Un joueur ne peut s'arrêter que lorsque le précédent a reposé son verre." },
  { id: "russe", name: "Shot russe", chill: 0, harr: 3, kind: "facilitator",
  ...
  { id: "enchere", name: "L'enchère des secs", chill: 0, harr: 2, kind: "offapp",
